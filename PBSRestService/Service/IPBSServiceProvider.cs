...
namespace PBS.Service
{
    ...
    public interface IPBSServiceProvider
    {
        ...
        [WebGet(UriTemplate = "/FMS/rest/info?f={f}&callback={callback}", BodyStyle = WebMessageBodyStyle.Bare)]
        Stream GenerateArcGISServerInfo(string f, string callback);

        [OperationContract(Name = "GenerateArcGISServerEndpointInfo")]
        [WebGet(UriTemplate = "/FMS/rest/services?f={f}&callback={callback}", BodyStyle = WebMessageBodyStyle.Bare)]
        ...
        [WebGet(UriTemplate = "/FMS/rest/services/{servicename}/MapServer?f={f}&callback={callback}", BodyStyle = WebMessageBodyStyle.Bare)]
        ...
        [WebGet(UriTemplate = "/FMS/rest/services/{servicename}/MapServer/{operation}?f={f}&callback={callback}", BodyStyle = WebMessageBodyStyle.Bare)]
        Stream GenerateArcGISServiceInfo(string serviceName, string operation,string f, string callBack);

        [OperationContract]
        [WebGet(UriTemplate = "/FMS/rest/services/{servicename}/MapServer/tile/{level}/{row}/{col}", BodyStyle = WebMessageBodyStyle.Bare)]
        ...
        [WebGet(UriTemplate = "/FMS/rest/services/{servicename}/MapServer/WMTS/{version}/WMTSCapabilities.xml", BodyStyle = WebMessageBodyStyle.Bare)]
        ...
        [WebGet(UriTemplate = "/FMS/rest/services/{servicename}/MapServer/WMTS", BodyStyle = WebMessageBodyStyle.Bare)]
        Stream GenerateWMTSCapabilitiesRedirect(string serviceName);

        [OperationContract(Name = "GenerateWMTSCapabilitiesKVP")]
        [WebGet(UriTemplate = "/FMS/rest/services/{servicename}/MapServer/WMTS?service=WMTS&request=GetCapabilities&version={version}", BodyStyle = WebMessageBodyStyle.Bare)]
        ...
        [WebGet(UriTemplate = "/FMS/rest/services/{servicename}/MapServer/WMTS/tile/{version}/{layer}/{style}/{tilematrixset}/{tilematrix}/{row}/{col}.{format}", BodyStyle = WebMessageBodyStyle.Bare)]
        ...
        [WebGet(UriTemplate = "/FMS/rest/services/{servicename}/MapServer/WMTS?service=WMTS&request=GetTile&version={version}&layer={layer}&style={style}&tileMatrixSet={tilematrixset}&tileMatrix={tilematrix}&tileRow={row}&tileCol={col}&format={format}", BodyStyle = WebMessageBodyStyle.Bare)]
        ...
        [WebInvoke(UriTemplate = "/FMS/rest/admin/addService", BodyStyle = WebMessageBodyStyle.Bare)]
        Stream AddPBSService(Stream requestBody);
        //[WebInvoke(UriTemplate = "/FMS/rest/admin/createservice?name={name}&port={port}&datasourcetype={datasourcetype}&datasourcepath={datasourcepath}&allowmemorycache={allowmemorycache}&disableclientcache={disableclientcache}&displaynodatatile={displaynodatatile}&visualstyle={visualstyle}&tilingschemepath={tilingschemepath}", BodyStyle = WebMessageBodyStyle.Bare)]
        ...
        [WebInvoke(UriTemplate = "/FMS/rest/admin/deleteService", BodyStyle = WebMessageBodyStyle.Bare)]
        Stream DeletePBSService(Stream requestBody);

        [OperationContract(Name = "ClearMemcacheByService")]
        [WebInvoke(UriTemplate = "/FMS/rest/admin/memCache/clearByService", BodyStyle = WebMessageBodyStyle.Bare)]
        Stream ClearMemcacheByService(Stream requestBody);

        [OperationContract(Name = "EnableMemcache")]
        [WebInvoke(UriTemplate = "/FMS/rest/admin/memCache/enable", BodyStyle = WebMessageBodyStyle.Bare)]
        Stream EnableMemcache(Stream requestBody);

        [OperationContract(Name = "DisableMemcache")]
        [WebInvoke(UriTemplate = "/FMS/rest/admin/memCache/disable", BodyStyle = WebMessageBodyStyle.Bare)]
        Stream DisableMemcache(Stream requestBody);

        [OperationContract(Name = "ChangeParamsArcGISDynamicMapService")]
        [WebInvoke(UriTemplate = "/FMS/rest/admin/ArcGISDynamicMapService/changeParams", BodyStyle = WebMessageBodyStyle.Bare)]
